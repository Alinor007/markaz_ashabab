...
class MarkazApp extends StatefulWidget {
  const MarkazApp({super.key, this.database});
...
class _MarkazAppState extends State<MarkazApp> {
  ...
  late final MinutesReportRepository _minutesReports = MinutesReportRepository(
    _db,
  );
  ...
  late final SidebarController _sidebar = SidebarController();
  ...
  Widget build(BuildContext context) {
    return MultiProvider(
      providers: [
        ...
        ChangeNotifierProvider.value(value: _sidebar),
      ],
